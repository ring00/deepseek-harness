...
Requires: `agents` · `skills` · `tools` · `commands` · `credentials` · `settings`
...
Source: [`packages/compat/agent-plugins/src/index.ts:31`](../packages/compat/agent-plugins/src/index.ts)
