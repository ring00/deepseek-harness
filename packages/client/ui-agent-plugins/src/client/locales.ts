...
export const en = {
  ...
  nextSessions: 'Next sessions', currentSession: 'Current session', agentPluginsFormat: 'Agent Plugin 1.0', claudeFormat: 'Claude Code',
  ...
  toggleError: 'The plugin setting could not be saved.', skill: 'skill', skills: 'skills', command: 'command', commands: 'commands',
  mcpServer: 'MCP server', mcpServers: 'MCP servers',
} as const
...
export const zh: Record<AgentPluginsLocaleKey, string> = {
  ...
  nextSessions: '后续会话', currentSession: '当前会话', agentPluginsFormat: 'Agent Plugin 1.0', claudeFormat: 'Claude Code',
  notice: '发现的插件默认启用。技能会影响模型指令，stdio MCP 会运行主机代码，更改将在新会话中生效。',
  toggleError: '无法保存插件设置。', skill: '技能', skills: '技能', command: '命令', commands: '命令',
  mcpServer: 'MCP 服务器', mcpServers: 'MCP 服务器',
}
