...
The browser roster mounts the [Markdown image policy](../../client/ui-markdown-images/README.md) by default. Its `trustedOrigins` exceptions remain `cordis.patch.yml` or downstream `cordis.yml` configuration; the Web bundle grants none.
